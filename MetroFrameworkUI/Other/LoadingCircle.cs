...
namespace MetroFramework.Other
{
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            if (off_screen == null) {
                ...
                using (Graphics g = Graphics.FromImage(off_screen)) {
                    g.CopyFromScreen(this.PointToScreen(Point.Empty), Point.Empty, ClientSize);
                ...
                //this.BackgroundImage = off_screen;
            }
            e.Graphics.Clear(Color.Transparent);
            //base.OnPaint(e);
            e.Graphics.DrawImage(off_screen, Point.Empty);
            if (m_NumberOfSpoke > 0) {
    ...
    partial class LoadingCircle
    {
        ...
        #region how to use
        /*
    string sloding = "正在导入资源,请稍等…";
            //IRQ_MainUICtl.ShowLoadingFrm(sloding);
            LoadingCircle lc = new LoadingCircle();
            //lc.BackColor = Color.Transparent;
            lc.Location = new Point(0, 0);
            lc.Size = this.Size;
            lc.Text = sloding;
            lc.StylePreset = LoadingCircle.StylePresets.Firefox;
            //lc.BackColor = System.Drawing.Color.Transparent;
            lc.Color = System.Drawing.Color.DarkOrange;
            lc.ForeColor = System.Drawing.Color.Red;
            lc.InnerCircleRadius = 30;
            lc.NumberSpoke = 16;
            lc.OuterCircleRadius = 60;
            lc.RotationSpeed = 90;
            lc.SpokeThickness = 8;
