...
namespace MetroFramework.MediaSlider
{
    /// <summary>
    /// 需要增加绘制时间 
    /// </summary>
    ...
    public partial class MediaSlider : UserControl
    {
        ...
        [Description("Raised when the mSlider has scrolled on mouse up.")]
        public event ScrollDelegate Scrolled_End;
        #endregion
        ...
        /// 点击鼠标 驱动滑杆
        /// </summary>
        public bool CanMouseClickToScroll = false;
        /// <summary>
        /// 按键 上下左右 驱动滑杆
        /// </summary>
        public bool CanKeyClickTiScroll = false;
        protected override void OnMouseClick(MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left && CanMouseClickToScroll)
            {
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left && _bInTarget) {
                if (Scrolled_End != null) {
                    Scrolled_End(this, new EventArgs());
                }
            }
